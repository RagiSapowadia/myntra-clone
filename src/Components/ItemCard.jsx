  ...
  return (
    <div className="item-card" key={index}>
      ...
      <div className="item-action">
        ...
        <button
          className="wishlist-button add-to-wishlist center border"
        ...
        <button
          className="wishlist-button remove-from-wishlist center border"
          onClick={() => dispatch(removeItemFromWishlist(item))}
          style={{ display: !isWishlisted ? "none" : "block" }}
        >
          <i class="fas fa-heart heart-remove" style={{ color: "red" }}></i>
          &nbsp; WISHLISTED
        </button>
        <p className="available-sizes border mx-1">
          <span style={{ color: "black" }}>Sizes</span>: 38, 40, 42, 44, 46
        </p>
      </div>
